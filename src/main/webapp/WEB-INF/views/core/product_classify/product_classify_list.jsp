...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="product.classify"/> - <s:message code="list"/></span>
...
<form action="list.do" method="get">
    ...
    <legend><s:message code="search"/></legend>
	  <label class="c-lab">分类名称: <input type="text" name="search_CONTAIN_classifyName" value="${search_CONTAIN_classifyName[0]}" style="width:120px;"/></label>
...
<tags:search_params/>
<div class="ls-bc-opt">
	<shiro:hasPermission name="core:product_classify:create">
...
<table id="pagedTable" border="0" cellpadding="0" cellspacing="0" class="ls-tb margin-top5">
  ...
  <tr class="ls_table_th">
    ...
    <th class="ls-th-sort"><span class="ls-sort" pagesort="sourceId">商品等级</span></th>
    <th class="ls-th-sort"><span class="ls-sort" pagesort="beforeClassifyName">上级分类</span></th>
    <th class="ls-th-sort"><span class="ls-sort" pagesort="classifyName">分类名称</span></th>
  </tr>
  </thead>
  <tbody>
  ...
  <tr<shiro:hasPermission name="core:product_classify:edit"> ondblclick="location.href=$('#edit_opt_${bean.id}').attr('href');"</shiro:hasPermission>>
    ...
    <td align="center">${bean.classifyName}</td>
  </tr>
  </c:forEach>
  </tbody>
</table>
