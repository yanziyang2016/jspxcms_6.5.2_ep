...
public class OAuthRegisterController {
	 ...
	 * OAUTH注册地址
	 */
	public static final String OAUTH_REGISTER_URL = "/oauth/register.jspx";
	/**
	 * OAUTH注册模板
	 */
	...
	@RequestMapping(value = { "/oauth/bind.jspx",
			Constants.SITE_PREFIX_PATH + "/oauth/bind.jspx"}, method = RequestMethod.POST)
